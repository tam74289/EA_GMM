var waxjs = (function(t) {
    ...
    function(t, e, r) {
        ...
        function y(t, e) {
            void 0 === e && (e = 1);
            for (
                var r = Array(e).fill("0".charCodeAt(0)), n = t.length - 1; n >= 0;
                --n
            ) {
        ...
        function b(t, e) {
            for (
                var r = new Uint8Array(t.length + e.length), n = 0; n < t.length;
                ++n
            )
                r[n] = t[n];
                                                ...
                                                return i(this, function(r) {
                                                    switch (r.label) {
                                                        case 0:
                                                            return (
                                                                (t = [this.pubKeys]),
                                                                (e = this.apiSigner) ? [4, this.apiSigner.getAvailableKeys()] : [3, 2]
                                                            );
                                                        case 1:
                                                            (e = r.sent()), (r.label = 2);
                                                        case 2:
                                                ...
                                                return i(this, function(i) {
                                                    switch (i.label) {
                                                        ...
                                                        case 1:
                                                            return (
                                                                (r = [i.sent()]),
                                                                (n = this.apiSigner) ? [4, this.apiSigner.sign(t)] : [3, 3]
                                                            );
                                                        case 2:
                                                ...
                                                switch (n.label) {
                                                    ...
                                                    case 1:
                                                        return n.sent() ? [3, 3] :
                                                            ((r = this), [
                                                                4,
                                                                window.open(p, "WaxPopup", "height=800,width=600"),
                                                            ]);
                                                    case 2:
                                ...
                                switch (n.label) {
                                    case 0:
                                        return [
                                            4,
                                            this.waxEventSource.openEventSource(
                                                this.waxSigningURL + "/cloud-wallet/signing/", { type: "TRANSACTION", transaction: e },
                                                t
                                            ),
                                        ];
                                    case 1:
                                ...
                                if ("TX_SIGNED" === t.data.type) {
                                    if (
                                        ((e = t.data),
                                            (r = e.verified),
                                            (n = e.signatures),
                                            (o = e.whitelistedContracts), !r || null == n)
                                    )
                            ...
                            i(this, void 0, void 0, function() {
                                ...
                                return o(this, function(o) {
                                    switch (o.label) {
                                        ...
                                        case 1:
                                            return (
                                                o.trys.push([1, 3, , 4]), [4, this.abiProvider.getRawAbi(t)]
                                            );
                                        case 2:
                                            return (
                                                (n = o.sent().abi),
                                                (i = this.rawAbiToJson(n)),
                                                (r = { rawAbi: n, abi: i }), [3, 4]
                                            );
                                        case 3:
                                            throw (
                                                (((a = o.sent()).message =
                                            ...
                                            return i(s, void 0, void 0, function() {
                                                ...
                                                return o(this, function(n) {
                                                    switch (n.label) {
                                                        case 0:
                                                            return (
                                                                (r = { accountName: t }), [4, this.getCachedAbi(t, e)]
                                                            );
                                                        case 1:
                                ...
                                return o(this, function(o) {
                                    switch (o.label) {
                                        ...
                                        case 1:
                                            ...
                                            try {
                                                for (
                                                    u = c(i.actions), f = u.next(); !f.done; f = u.next()
                                                )
                                                    (h = f.value),
                                                    (p = h.name),
                                                    (d = h.type),
                                ...
                                switch (i.label) {
                                    case 0:
                                        return (
                                            ...
                                            (e = this.deserializeTransaction(t)), [4, this.deserializeActions(e.actions)]
                                        );
                                    case 1:
                                ...
                                switch (o.label) {
                                    ...
                                    case 7:
                                        return (
                                            (i = o.sent()),
                                            (a = [{}, t]),
                                            (u = {}), [4, this.serializeActions(t.actions)]
                                        );
                                    case 8:
                                        return (
                                            (t = n.apply(
        ...
        var n = function(t, e) {
                ...
                if (Symbol.iterator in Object(t))
                    return (function(t, e) {
                        ...
                        try {
                            for (
                                var a, s = t[Symbol.iterator](); !(n = (a = s.next()).done) &&
                                (r.push(a.value), !e || r.length !== e); n = !0
                            );
                        } catch (t) {
                            (i = !0), (o = t);
                        } finally {
                            ...
                            return i(this, function(n) {
                                switch (n.label) {
                                    ...
                                    case 1:
                                        return (
                                            (e = n.sent()),
                                            (r = a.base64ToBinary(e.abi)), [2, { accountName: e.account_name, abi: r }]
                                        );
                                }
                            });
                        });
                                        ...
                                        ((s = function(t) {
                                                return n(c, void 0, void 0, function() {
                                                    return i(this, function(r) {
                                                        return (
                                                            "READY" === t.data.type &&
                                                            o.postMessage(e, this.waxSigningURL), [2]
                                                        );
                                                    });
                                                });
                                            }),
                                            ...
                                            return n(this, void 0, void 0, function() {
                                                ...
                                                return i(this, function(i) {
                                                    switch (i.label) {
                                                        ...
                                                        case 4:
                                                            return (
                                                                window.removeEventListener("message", s, !1), [2]
                                                            );
                                                    }
                                                });
                                            });
